...
export default function Home() {
  ...
  const pastMatches = matches.filter((m) => new Date(m.B) < today);
  const upcomingMatches = matches.filter((m) => new Date(m.B) >= today);
    ...
    <div style={{ ...styles.container, paddingBottom: "80px" }}>
            ...
            <Link to={item.path} key={index} style={styles.link}>
              <div
                ...
                style={{
                  ...
                  boxShadow: isHover
                    ? `0 0 10px ${item.color}, 0 8px 20px rgba(0,0,0,0.7)`
              ...
              >
                ...
                <h3
                  style={{
                    ...
                    textShadow: isHover
                      ? `0 0 2px ${item.color}, 0 0 6px ${item.color}`
                      : "none",
                  }}
                >
                  {item.title}
      ...
      <div style={{ ...styles.section, marginTop: "50px" }}>
        ...
        {pastMatches.length === 0 ? (
          ...
          pastMatches.slice(-5).reverse().map((m, i) => (
